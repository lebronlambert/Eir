...
def updatestate(text,text2,append1,append2,append3,mode):
...
def main(args):
    ...
    while True:
        ...
        if message == "newGame":
            ...
            if abstract_mode:
                entity,newstate=updatestate(run_abstract,run_title, run_journal, run_index_truth, run_author,abstract_mode)
            else:
                entity,newstate=updatestate(run_title, run_title,run_journal, run_index_truth, run_author, abstract_mode)
