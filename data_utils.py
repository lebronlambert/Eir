...
#   train_set = {'samples':samples[0:num_train_samples],'labels':y[0:num_train_samples],'pmids':samples_pmid[0:num_train_samples]}
#   test_set = {'samples':samples[num_train_samples:],'labels':y[num_train_samples:],'pmids':samples_pmid[num_train_samples:]}
